                                                ...
                                                <div className="row">
                                                    <div className="col-12 col-sm-auto mb-3">
                                                        <div className="mx-auto" style={{ width: "140px" }}>
                                                            <div className="col-4">
                                                                <img src="//static.naukimg.com/s/5/105/i/displayProfilePlaceholder.png" style={{ width: "140px", height: "140px", borderRadius: "50%" }} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                                        ...
                                                        <div className="text-center text-sm-right">
                                                            <span className="badge text-bg-primary fs-5">Admin</span>
